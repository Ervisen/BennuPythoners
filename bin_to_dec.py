def decimal(binary_str):
    """Convierte cadanas bianrias a sus equivalentes decimales.
    Lanzar ValueError si binary_str contiene caractees distintos a de 0y 1"""
    ...
    for bit in binary_str[::-1]: # Bucle desde el final de la cadena hasta el principio
        if (bit =='1'): # Si el dígito es un 1, agrege el valor posicional. Si es 0, ignorar.
            dec += place
